			...
			<div class="col-lg-12 text-center border rounded bg-light my-5">
				<form action="" method="post" class="text-center graphForm">
					...
					<div class="form-outline mb-4 w-50 m-auto">
						...
						<input type="text" name="main-product_id" value="" id="main-Product" class="form-control inputProductId" required>
					</div>
					<div class="form-outline mb-4 w-50 m-auto">
						<label class="form-label">User Id ( *optional)</label>
						<input type="text" name="main-user_id" value="" id="category_name" class="form-control inputUserId" required>
					</div>
					<div class="form-outline mb-4 w-50 m-auto">
					...
					<div class="container compareContainer">
						...
						<div class="form-outline mb-4 w-50 m-auto">
							<label class="form-label">Select year</label>
							<select class="form-select " name="main_category" onchange="getSubCategory(event, this)" aria-label="Default select example">
								<!-- <option value="" selected>Default</option> -->
							</select>
						</div>
						<!-- <input type="submit" name="edit_category" value="Search" class="btn btn-info px-3 mb-3 searchCategory"> -->
						<div class="form-outline mb-4 w-50 m-auto">
							<label class="form-label">Select Month</label>
							<select class="form-select sub_category month sec-month" name="sub_category" aria-label="Default select example">
								<option value="" selected>Default</option>
							</select>
						</div>
						<div class="form-outline mb-4 w-50 m-auto">
