        ...
        <form action='manage_cart.php' method='post' class='cartForm'>
            <div class='card'>
                ...
                <div class='card-body'>
                    ...
                    <a href='details.php?product_id=]'><input type='submit' name='detail' value='Delete' class='button outline deleteProBtn' onclick="deleteProduct(event, this, ${currentoffsetSearch})"></a>
                    <input type='submit' name='' value='Edit' class='button fill editProduct' onclick = "openEditForm(event, this, ${currentoffsetSearch})">
